...
export function getFrequentlyUsedMenu() {
  return {
    ...
    config: {
      ...
      // be an object containing a single "maxNum" property. To stay backwards compatible
      // with Fly-Pie 4, we have to also handle the case where the number is given as a

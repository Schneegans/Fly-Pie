...
export function getCommandAction() {
  return {
    ...
    config: {
      ...
      // be an object containing a single "command" property. To stay backwards compatible
      // with Fly-Pie 4, we have to also handle the case where the command is given as a

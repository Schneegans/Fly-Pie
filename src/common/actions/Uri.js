...
export function getUriAction() {
  return {
    ...
    config: {
      ...
      // be an object containing a single "uri" property. To stay backwards compatible
      // with Fly-Pie 4, we have to also handle the case where the URI is given as a

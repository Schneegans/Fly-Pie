...
export function getFileAction() {
  return {
    ...
    config: {
      ...
      // be an object containing a single "file" property. To stay backwards compatible
      // with Fly-Pie 4, we have to also handle the case where the file is given as a
